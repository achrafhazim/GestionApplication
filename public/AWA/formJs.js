...
///  li nafdarid matalan 
            ...
            function create_form_dynamique_table(tables_CHILDREN, schemas_CHILDREN, schemas_relation_CHILDREN) {
                ...
                function tableModulInput() {
                    return `<table  class="table  table-hover table-sortable table-sm ">
                     <thead>
                    <tr>
                ...
                function activeDynamiqueTable(id) {
                    // tableform for chile  autoadd , style file icon  
                    var DynamiqueTable = function (config) {
        ...
        function get_where(schemas_CHILDREN) {
